...
def args_parser():
    ...
    parser.add_argument('--user_id', type=int, default=1, help="id of current user: ID")
    ...
    parser.add_argument("--model_def", type=str,
                        default="service/federated/config/preliminary_contest_crane_federal"
    ...
    parser.add_argument('--server_port', type=int, default=5014, help="port of server: SP")
    parser.add_argument('--client_ip', type=str, default="127.0.0.1", help="internet protocol of client: CI")
    parser.add_argument('--client_port', type=int, default=5015, help="port of client: CP")
